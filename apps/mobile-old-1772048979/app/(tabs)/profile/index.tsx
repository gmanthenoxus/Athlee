...
import type { MockFollowerUser, PlayerProfile } from '@athlehub/shared';

export default function ProfileScreen() {
  const { user, logout } = useAuth();
  const { currentProfile, isLoading, updateProfile, getFollowersList, getFollowingList } = useProfile();
  ...
  // Handle both player and business profiles
  ...
  const lastName = playerProfile?.lastName || '';
  ...
  const colorIndex = (displayName || 'U').charCodeAt(0) % colors.length;
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          {playerProfile && (
            <View style={styles.sportBadge}>
              <Text style={styles.sportBadgeText}>{playerProfile.primarySport}</Text>
            </View>
          )}

          {/* Bio */}
          {playerProfile?.bio && (
            <Text style={styles.bio}>{playerProfile.bio}</Text>
          )}

          {/* Location */}
          {playerProfile?.locationTag && (
            <Text style={styles.location}>📍 {playerProfile.locationTag}</Text>
          )}
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statValue}>{playerProfile?.xp || 0}</Text>
        ...
        {playerProfile && (
          <View style={styles.section}>
            ...
            <View style={styles.settingRow}>
              ...
              <Switch
                value={playerProfile.isPublicStats}
            ...
            <View style={styles.settingRow}>
              ...
              <Switch
                value={playerProfile.isPublicBadges}
            ...
            <View style={styles.settingRow}>
              ...
              <Switch
                value={playerProfile.isPublicPosts}
        ...
        {!isPlayerProfile && user && (
          <BusinessLocations userId={user.id} />
        )}
