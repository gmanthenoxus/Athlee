...
import { SOCCER_CONFIG } from './soccerConfig';
import { TENNIS_CONFIG } from './tennisConfig';
import { BADMINTON_CONFIG } from './badmintonConfig';
import { PICKLEBALL_CONFIG } from './pickleballConfig';
import { VOLLEYBALL_CONFIG } from './volleyballConfig';
import { BASEBALL_CONFIG } from './baseballConfig';
import { AMERICAN_FOOTBALL_CONFIG } from './americanFootballConfig';
