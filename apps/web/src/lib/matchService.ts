...
class MatchService {
  ...
  public createMatch(matchData: Partial<Match>): Match {
    ...
    const newMatch: Match = {
      ...
      teamSize: matchData.teamSize || { label: '5v5', playersPerTeam: 5, substitutes: 3 },
      statIntensity: matchData.statIntensity || 'Basic' as any,
  ...
  public getDefaultRules(sport?: SportType, type?: MatchType): MatchRules {
    ...
    const { getDefaultPreset } = require('./mockRulePresets');
