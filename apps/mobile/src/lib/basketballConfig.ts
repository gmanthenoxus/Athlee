/**
 * Basketball Sport Configuration (Mobile)
 * 
 * Note: This shares the same configuration as the web app.
 * Full implementation with all team sizes, positions, and rule presets.
 */
...
/**
 * Streetball Rule Preset
 */
const STREETBALL_RULES: MatchRules = {
  scoringSystem: 'Streetball' as any,
  pointsToWin: 23,
  winByTwo: true,
  customRules: 'Pickup game rules - call your own fouls',
};

export const STREETBALL_PRESET: RulePreset = {
  name: 'Streetball',
  description: 'Pickup game rules',
 ...
 */
export const BASKETBALL_RULE_PRESETS: RulePreset[] = [STREETBALL_PRESET];
